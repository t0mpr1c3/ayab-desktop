...
class TestKnitControl(unittest.TestCase):
    ...
    def test_select_needles_API5(self):
        control = KnitControl(self.parent)
        ...
        assert control.select_needles_API5(0, 0, False) == bits0
        ...
        assert control.select_needles_API5(0, 0, False) == bits1
        ...
        assert control.select_needles_API5(2, 1, False) == ~bits1
        control.mode = KnitMode.MIDDLECOLORSTWICE_RIBBER
        assert control.select_needles_API5(2, 1, False) == ~bits1
        ...
        assert control.select_needles_API5(0, 0, False) == bitarray([True] * Machine(0).width)
