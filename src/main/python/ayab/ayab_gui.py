...
class Ui_MainWindow(object):
    def setupUi(self, Ui_MainWindow):
        ...
        self.scene = QtWidgets.QGraphicsView(self.graphics_splitter)
        self.scene.setGeometry(QtCore.QRect(0, 0, 700, 686))
        self.scene.setObjectName("scene")
        self.kp = QtWidgets.QScrollArea(self.graphics_splitter)
        self.kp.setGeometry(QtCore.QRect(0, 0, 700, 220))
